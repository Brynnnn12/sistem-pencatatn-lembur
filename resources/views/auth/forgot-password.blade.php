<x-layout.auth title="Lupa Kata Sandi" subtitle="Masukkan email Anda untuk menerima tautan reset kata sandi">
    ...
    <div class="text-center mb-6">
        ...
        <h2 class="text-xl sm:text-2xl font-bold text-gray-800 mb-1">Reset Kata Sandi</h2>
        <p class="text-sm text-gray-600">Kami akan mengirimkan tautan reset</p>
    </div>
    ...
    <form method="POST" action="{{ route('password.email') }}" class="space-y-4">
        ...
        <div>
            <label for="email" class="block text-sm font-medium text-gray-700 mb-1.5">
                <i class="fas fa-envelope mr-1.5 text-gray-400 text-xs"></i>Alamat Email
            </label>
        ...
        <button type="submit"
            ...
            <i class="fas fa-paper-plane mr-2 text-xs"></i>Kirim Tautan Reset
        </button>
        ...
        <a href="{{ route('login') }}"
            ...
            <i class="fas fa-arrow-left mr-2 text-xs"></i>Kembali ke Login
        </a>
    </form>
</x-layout.auth>
