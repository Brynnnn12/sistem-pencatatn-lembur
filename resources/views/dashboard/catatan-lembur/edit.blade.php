<x-layout.dashboard title="Edit Catatan Lembur">
    <div class="container mx-auto px-4 py-8">
        <div class="max-w-4xl mx-auto">
            <div class="bg-white shadow-md rounded-lg overflow-hidden">
                ...
                <!-- Form -->
                <form method="POST" action="{{ route('catatan-lembur.update', $catatanLembur) }}" class="p-6 space-y-6">
                    @csrf
                    @method('PUT')
                            ...
                            <select name="karyawan_id" id="karyawan_id"
                                ...
                                @foreach ($karyawans as $karyawan)
                                    <option value="{{ $karyawan->id }}"
                                        {{ old('karyawan_id', $catatanLembur->karyawan_id) == $karyawan->id ? 'selected' : '' }}>
                    ...
                    <div>
                        ...
                        <input type="date" name="tanggal" id="tanggal"
                            value="{{ old('tanggal', $catatanLembur->tanggal->format('Y-m-d')) }}"
