                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div class="bg-gradient-to-r from-blue-50 to-blue-100 p-6 rounded-xl text-center">
                                ...
                                <p class="text-3xl font-bold text-blue-700">
                                    {{ date('H:i', strtotime($catatanLembur->jam_masuk)) }} WIB</p>
                            </div>
                            <div class="bg-gradient-to-r from-green-50 to-green-100 p-6 rounded-xl text-center">
                                ...
                                <p class="text-3xl font-bold text-green-700">
                                    {{ date('H:i', strtotime($catatanLembur->jam_keluar)) }} WIB</p>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="space-y-3">
                                    ...
                                    <div class="flex justify-between">
                                        ...
                                        <span
                                            class="font-medium">{{ date('H:i', strtotime($catatanLembur->jam_masuk)) }}
                                            WIB</span>
                                    </div>
                                    <div class="flex justify-between">
                                        <span class="text-gray-600">Jam Keluar:</span>
                                        <span
                                            class="font-medium">{{ date('H:i', strtotime($catatanLembur->jam_keluar)) }}
                                            WIB</span>
                                    </div>
                                    <div class="flex justify-between">
