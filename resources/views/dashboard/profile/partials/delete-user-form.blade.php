<section class="space-y-6">
    ...
    <x-ui.danger-button x-data=""
        x-on:click.prevent="$dispatch('open-modal', 'confirm-user-deletion')">{{ __('Delete Account') }}</x-uidanger-button>
        ...
        <x-ui.modal name="confirm-user-deletion" :show="$errors->userDeletion->isNotEmpty()" focusable>
            <form method="post" action="{{ route('profile.destroy') }}" class="p-6">
                ...
                <div class="mt-6">
                    ...
                    <x-ui.text-input id="password" name="password" type="password" class="mt-1 block w-3/4"
